...
lossX = []  # Empty array to hold loss values
lossY = []  # Empty array to hold loss values
...
# 1. Write the code to save the graph then plot the graph in TensorBoard
writer1 = tf.summary.FileWriter("simple_ae.png", sess.graph)
# 2. Write the code to save the loss then plot the loss in TensorBoard
thePlot = plt.plot(lossX, lossY, 'ro')
plt.savefig('lossGraph.png')
writer2 = tf.summary.FileWriter("lossGraph.png", sess.graph)
